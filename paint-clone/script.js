...
function createCanvas() {
  ...
  switchToBrush() // By default, the brush is selected
}
...
// => if we don't do this, whenever we change the background of the canvas, 
//    createCanvas() is going to be called and all of the drawings are going to disappear
//    so we have to call this function when the background color changes
